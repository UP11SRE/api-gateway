...
axios.post(CONFIG_API_URL, { environment: ENVIRONMENT, service: SERVICE_NAME })
  .then(response => {
    ...
    process.env.INTERCOM_BASE_URL = configuration.INTERCOM_BASE_URL;
    process.env.PRODUCT_BASE_URL = configuration.PRODUCT_BASE_URL;
    process.env.PORT = configuration.PORT;
    process.env.USER_BASE_URL = configuration.USER_BASE_URL;
    process.env.ORDER_BASE_URL = configuration.ORDER_BASE_URL;
